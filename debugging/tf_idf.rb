...
# He decides to try a simple implementation of TF-IDF, a measure of the information content a
# term holds for a particular document in a document collection. However, he just started learning to code
# and somehow his numbers do not match what is expected. He knows you're enrolled in an awesome developer school, so he asks you to have a look.
...
def tf(term, document)
  ...
  res = document.split(/[\s-]/).count { |word| word.downcase == term }
...
def idf(term, documents)
  ...
  val = Math.log((number_of_documents * 1.0) / number_of_documents_with_term).round(22)
